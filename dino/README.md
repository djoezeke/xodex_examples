<p align="center"><h1 align="center"> DINO PROJECT </h1></p>
<p align="center">
	<em><code>Python Game/Graphics project with Xodex.
</code></em>
</p>
<p align="center">
	<img src="https://img.shields.io/github/license/username/dino?style=default&logo=opensourceinitiative&logoColor=white&color=0080ff" alt="license">
	<img src="https://img.shields.io/github/last-commit/username/dino?style=default&logo=git&logoColor=white&color=0080ff" alt="last-commit">
	<img src="https://img.shields.io/github/languages/top/username/dino?style=default&color=0080ff" alt="repo-top-language">
	<img src="https://img.shields.io/github/languages/count/username/dino?style=default&color=0080ff" alt="repo-language-count">
</p>
...
```sh
   git clone https://github.com/username/dino
   cd dino
```
...
- **💬 [Join the Discussions](https://github.com/username/dino/discussions)**: Share your insights, provide feedback, or ask questions.
- **🐛 [Report Issues](https://github.com/username/dino/issues)**: Submit bugs found or log feature requests for the `dino` project.
- **💡 [Submit Pull Requests](https://github.com/username/dino/blob/main/CONTRIBUTING.md)**: Review open PRs, and submit your own PRs.
...
2. **Clone Locally**: Clone the forked repository to your local machine using a git client.
   ```sh
   git clone --recursive https://github.com/username/dino
   ```
...
<br>
<p align="left">
   <a href="https://github.com{/username/dino/}graphs/contributors">
      <img src="https://contrib.rocks/image?repo=username/dino">
   </a>
</p>
</details>
